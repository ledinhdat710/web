...
for ($i = 1; $i <= $total_pages; $i++) {
    ...
    $list_pages .= '<li class="page-item ' . $active . '"><a class="page-link" href="index.php?page_layout=order&page=' . $i . '">' . $i . '</a></li>';
}
$page_next = $page + 1;
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Danh sách người đặt hàng</li>
        </ol>
    </div>
    <!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Danh sách người đặt hàng</h1>
        </div>
    </div>
    <!--/.row-->
    <div class="row">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style=""><?php echo $row['order_add']; ?></td>
                                    <td style=""><?php echo $row['prd_name']; ?></td>
                                    <td style=""><?php echo $row['prd_qtt']; ?></td>
                                    <td style=""><?php echo number_format($row['price']); ?> đ</td>
                                    <td class="form-group">
                                    </td>
                                </tr>
                            <?php
